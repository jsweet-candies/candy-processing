...
declare class PApplet implements PConstants {
     ...
     * @return {*}
     */
    public static launch(...args : string[]) : any;
     ...
     * @param {Array} args
     */
    public static exec(...args : string[]) : any;
     ...
     * @return {JSONObject}
     */
    public static loadJSONObject(file : any) : JSONObject;
    ...
    public static loadJSONArray(file : any) : JSONArray;
    ...
    public selectInput(prompt : string, callback : string, file : any);

    public selectInput(prompt : string, callback : string, file : any, callbackObject : any);

    public static selectInput(prompt : string, callbackMethod : string, file : any, callbackObject : any, parent : any, sketch : PApplet);

    public static selectInput(prompt : string, callbackMethod : string, file : any, callbackObject : any, parent : any);
    ...
    public selectOutput(prompt : string, callback : string, file : any);

    public selectOutput(prompt : string, callback : string, file : any, callbackObject : any);

    public static selectOutput(prompt : string, callbackMethod : string, file : any, callbackObject : any, parent : any);

    public static selectOutput(prompt : string, callbackMethod : string, file : any, callbackObject : any, parent : any, sketch : PApplet);

    static selectImpl(prompt : string, callbackMethod : string, defaultSelection : any, callbackObject : any, parentFrame : any, mode : number, sketch : PApplet);
    ...
    public selectFolder(prompt : string, callback : string, file : any);

    public selectFolder(prompt : string, callback : string, file : any, callbackObject : any);

    public static selectFolder(prompt : string, callbackMethod : string, defaultSelection : any, callbackObject : any, parentFrame : any);

    public static selectFolder(prompt : string, callbackMethod : string, defaultSelection : any, callbackObject : any, parentFrame : any, sketch : PApplet);

    static selectCallback(selectedFile : any, callbackMethod : string, callbackObject : any);

    public listPaths(path : string, ...options : string[]) : string[];

    public listFiles(path : string, ...options : string[]) : any;

    public static listFiles(base : any, ...options : string[]) : any;

    static listFilesImpl(folder : any, recursive : boolean, extensions : string[], hidden : boolean, directories : boolean, files : boolean, list : Array<any>);
     ...
     * @return {*}
     */
    public static createReader(file : any) : { str: string, cursor: number };
     ...
     * @return {*}
     */
    public createWriter(filename : string) : any;
     ...
     * @return {*}
     */
    public static createWriter(file : any) : any;
     ...
     * @return {*}
     */
    public static createWriter(output : any) : any;
     ...
     * @return {*}
     */
    public static createInput(file : any) : { str: string, cursor: number };
     ...
     * @return {Array}
     */
    public static loadBytes(file : any) : number[];
     ...
     * @return {Array}
     */
    public static loadStrings(file : any) : string[];
     ...
     * @return {*}
     */
    public createOutput(filename : string) : any;
     ...
     * @return {*}
     */
    public static createOutput(file : any) : any;
     ...
     * @return {boolean}
     */
    public saveStream(target : any, source : string) : boolean;
     ...
     * @return {boolean}
     */
    public static saveStream(target : any, source : { str: string, cursor: number }) : boolean;
     ...
     * @param {*} source
     */
    public static saveStream(target : any, source : { str: string, cursor: number });
     ...
     * @private
     */
    static createTempFile(file : any) : any;
     ...
     * @param {Array} data
     */
    public static saveBytes(file : any, data : number[]);
     ...
     * @param {Array} data
     */
    public static saveBytes(output : any, data : number[]);
     ...
     * @param {Array} data
     */
    public static saveStrings(file : any, data : string[]);
     ...
     * @param {Array} data
     */
    public static saveStrings(output : any, data : string[]);

    static calcSketchPath() : string;

    public sketchFile(where : string) : any;
     ...
     * @return {*}
     */
    public saveFile(where : string) : any;

    static desktopFolder : any;
     ...
     * @return {*}
     */
    public static desktopFile(what : string) : any;
     ...
     * @return {*}
     */
    public dataFile(where : string) : any;
    ...
    public static createPath(file : any);
