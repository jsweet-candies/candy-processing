...
declare class PGraphicsOpenGL extends PGraphics {
    ...
    static refQueue : java.lang.ref.ReferenceQueue<any>;

    static reachableWeakReferences : Array<PGraphicsOpenGL.Disposable<any>>;

    static MAX_DRAIN_GLRES_ITERATIONS : number;

    static drainRefQueueBounded();
    ...
    static defColorShaderVertURL : java.net.URL;

    static defTextureShaderVertURL : java.net.URL;

    static defLightShaderVertURL : java.net.URL;

    static defTexlightShaderVertURL : java.net.URL;

    static defColorShaderFragURL : java.net.URL;

    static defTextureShaderFragURL : java.net.URL;

    static defLightShaderFragURL : java.net.URL;

    static defTexlightShaderFragURL : java.net.URL;

    static defLineShaderVertURL : java.net.URL;

    static defLineShaderFragURL : java.net.URL;

    static defPointShaderVertURL : java.net.URL;

    static defPointShaderFragURL : java.net.URL;

    static maskShaderFragURL : java.net.URL;
...
declare namespace PGraphicsOpenGL {
    ...
    export class AsyncPixelReader {
        ...
        public readAndSaveAsync(file : java.io.File);
        ...
        awaitTransferCompletion(file : java.io.File);

        public isLastTransferComplete() : boolean;

        public beginTransfer(file : java.io.File);
