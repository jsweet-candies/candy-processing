...
declare class PImage implements PConstants {
    ...
    public constructor(img : java.awt.Image);
    ...
    /*private*/ static shrinkImage(img : java.awt.image.BufferedImage, targetWidth : number, targetHeight : number) : java.awt.image.BufferedImage;
    ...
    saveTIFF(output : java.io.OutputStream) : boolean;
     ...
     * @return {boolean}
     */
    saveTGA(output : java.io.OutputStream) : boolean;
    ...
    /*private*/ imageioWriter(extension : string) : javax.imageio.ImageWriter;

    /*private*/ imageioDPI(writer : javax.imageio.ImageWriter, param : javax.imageio.ImageWriteParam, dpi : number) : javax.imageio.metadata.IIOMetadata;
