# JSweet processing candy

## Description

This project is a Java bridge to the processing library, so that processing can be used from Java (thanks to the JSweet transpiler).
